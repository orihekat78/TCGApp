...
// 'on-set-self' (2026-07-11 夜間WA): 除去された setCard 自身の ability 走査 scope (B02084、faceUp gate)。
const ALLOWED_SCOPE = ['on-scene', 'on-hand', 'on-partner-area', 'on-evidence', 'on-set-host', 'on-set-self', 'always'];
