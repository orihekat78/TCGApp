...
const jobs = [
  {
    filename: 'history-stylish-desktop-1440x900-design-mock.png',
    url: source('history-stylish.html'),
  ...
  {
    filename: 'history-stylish-mobile-851x393-design-mock.png',
    url: source('history-stylish.html'),
...
console.log(`PASS: ${jobs.length} exact-dimension, nonblank, overflow-free revision-v2 PNGs`);
