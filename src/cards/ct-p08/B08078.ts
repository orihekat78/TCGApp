...
export const B08078: CardDef = {
  id: 'B08078', no: '0914/B08078', kind: 'character', names: ['ジン'], colors: ['黒'], level: 8, ap: 7000, lp: 2,
  traits: ['黒ずくめの組織'], keywords: ['現場リムーブ時'], rarity: 'SR', imageUrl: '1770731255796697.jpg', abilities,
