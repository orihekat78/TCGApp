// cards/ct-p08/B08063P 黒田兵衛 (parallel)
...
export const B08063P: CardDef = {
  id: 'B08063P', no: '0900/B08063P', kind: 'character', names: ['黒田兵衛'], colors: ['黄'],
  level: 8, ap: 7000, lp: 2, traits: ['警察', '警視庁'], keywords: [], rarity: 'SRP',
  imageUrl: '1770878984778580.jpg', abilities: [a1, a2, a3],
