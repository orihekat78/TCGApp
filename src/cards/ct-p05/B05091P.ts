// cards/ct-p05/B05091P 風見裕也 (character, parallel) — leave-from-remove wave (engine変更0)
// B05091 と effect 完全同一 (parallel: rarity/imageUrl/no のみ差異)。句マッピングは B05091.ts 参照。
