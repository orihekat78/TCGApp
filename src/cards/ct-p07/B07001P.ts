// cards/ct-p07/B07001P 毛利蘭＆灰原哀 (キャラ MR・パラレル) — S1 wave (2026-07-11)
...
//
// 公式テキスト・句マッピング: B07001.ts と同一。P 版差分は rarity / imageUrl / no のみ。
