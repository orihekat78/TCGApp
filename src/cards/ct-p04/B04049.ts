...
//   - このキャラをスリープさせ => atom sceneSetState {uid:'$self',state:'sleep'} as step 1 inside the optional chain [PR144.ts a1 step1 = {verb:'sceneSetState',args:{uid:'$self',state:'sleep'}}; capability-map sceneSetState honors uid:'$self'+state]
