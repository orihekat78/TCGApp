// cards/ct-p03/B03079P レイチェル・浅香 (character) — Task A green候補 (engine変更0)
...
//   - 残りを好きな順番でデッキの下に移す => a1.deckToBottomBound {player:'self', bindKey:'$revealed'} [atom-handlers.ts:1508 case 'deckToBottomBound' moves bound $revealed cardIds to deck bottom. Exemplar D05007.ts a1 + D01013.ts a1 identical. Note: engine preserves peek order; 「好きな順番」player-reorder is not surfaced (same as certified-green D05007/D01013 with maxN:3 remainder ≤2). Not a top/bottom-choose gate (always bottom, souza-like). Acceptable per exemplar certification.]
