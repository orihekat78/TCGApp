// cards/ct-p03/B03075 ジェイムズ・ブラック (キャラ) — engine拡張 wave#2 cluster13 (aura-grant, 2026-06-15)
// rules: 15-abilities-effects.md, 17-icons.md, 24-qa-naming-stun.md, 10-action-event.md, 14-refresh.md
//
// 公式テキスト: 【自分ターン中】自分の現場にいるこのキャラ以外の【赤】のキャラをAP＋1000する。
//
// 句マッピング:
//   - 【自分ターン中】自分の現場にいるこのキャラ以外の【赤】のキャラをAP＋1000する => type:'continuous' + condition{turn:self} +
...
const a1: AbilityDef = {
  ...
  continuousModifier: { apDeltaAura: 1000, auraFilter: { color: '赤', kind: 'character' }, auraExcludeSelf: true },
  description: '【自分ターン中】自分の現場にいるこのキャラ以外の【赤】のキャラをAP＋1000する。',
