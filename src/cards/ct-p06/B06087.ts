// cards/ct-p06/B06087 萩原千速 (character) — engine拡張 wave#2 cluster16 (self-remove removal-observer, 2026-06-18)
...
//
// 公式テキスト (PR280 と機能同一。a1 gloss のみ差「登場したターンからすぐにアクションできる」):
...
//
// 句マッピングは PR280.ts と同一 (certify .tmp/certify/B06087.json)。詳細は PR280.ts 冒頭コメント参照。
