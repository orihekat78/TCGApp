// cards/ct-p06/B06095 榎本梓誘拐事件
// rules: 01-victory-conditions.md, 03-field-areas.md, 15-abilities-effects.md, 21-declared-ability-cost.md
...
export const B06095: CardDef = {
  id: 'B06095', no: '0714/B06095', kind: 'case', names: ['榎本梓誘拐事件'], colors: ['黄'],
  caseTraits: [], traits: [], rarity: 'C', imageUrl: '1754285264355435.jpg', abilities: [a1, a2],
