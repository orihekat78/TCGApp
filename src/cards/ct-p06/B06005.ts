...
export const B06005: CardDef = { id: 'B06005', no: '0630/B06005', kind: 'character', names: ['阿笠博士'], colors: ['青'], level: 8, ap: 7000, lp: 2, traits: ['発明家'], keywords: [], rarity: 'R', imageUrl: '1754284680544930.jpg', abilities: [a1, a2], ruleRefs: ['rules/15-abilities-effects.md', 'rules/16-card-set.md', 'rules/21-declared-ability-cost.md'] };
