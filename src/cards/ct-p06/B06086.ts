// cards/ct-p06/B06086 萩原研二 (character) — Task A green候補 (engine変更0)
...
//   【ヒラメキ】（証拠からリムーブされるときに発動する）相手の裏向きの証拠を1つまで選び、表向きにする。
