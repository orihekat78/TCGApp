// cards/pr-01/PR200 大滝悟郎 (character)
...
//
// 公式テキスト:
//   自分の現場にいるキャラに裏向きでセットされているカードが合わせて2枚以上ある場合、このキャラは〚突撃〛を持つ。
//   【宣言】【ターン1】自分の現場にいる〚特徴［警察］〛のキャラを1枚まで選び、自分のデッキのカードを上から1枚裏向きでセットする。
//   【ヒラメキ】自分のリムーブエリアにある〚特徴［大阪府警］〛のキャラを1枚まで選び、手札に加える。
...
export const PR200: CardDef = {
  id: 'PR200', no: '0834/PR200', kind: 'character', names: ['大滝悟郎'], colors: ['緑'], level: 5, ap: 6000, lp: 0,
  traits: ['警察', '大阪府警'], rarity: 'PR', imageUrl: '1764290716034946.jpg', abilities: [a1, a2, a3],
