// cards/pr-01/PR106 宮野厚司 (キャラ) — Task D batch (2026-06-12)
// rules: 05-turn-phases.md, 09-cutin-disguise.md, 10-action-event.md, 14-refresh.md, 15-abilities-effects.md, 17-icons.md
//
// PR100 と同テキストの別カード (card_id 0487 共通、プロモーションパックVol.6 キラバージョン)。
// rules/02: ID が同じカードは同じカード扱い (絵柄違い)。full def 規約により別ファイル
// (rarity/imageUrl/no は PR106 のデータ)。
//
// 公式テキスト:
