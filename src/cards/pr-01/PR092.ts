// cards/pr-01/PR092 伊達航 (character) — engine拡張 wave#2 cluster3 (action-lifecycle trigger, 2026-06-14)
...
//
// 公式テキスト (PR086 と同一効果。P/別番号 再録版 = cardNum / imageUrl のみ異なる — TSV gameplay 列
//   effect/cutIn/hirameki/henso を byte 比較し完全一致 md5=aebbe0c47acd97f760c4ad16c9c90994 を確認。
//   B08005P 慣行に従い full def を複製し id/no/imageUrl のみ差替 / rarity は TSV 値 'PR'):
