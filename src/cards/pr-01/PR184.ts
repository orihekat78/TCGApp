// cards/pr-01/PR184 「助けて平次ィ!!!」 (event) — Task A green候補 (engine変更0)
...
//   - 自分のデッキのカードを上から3枚リムーブ => a1 chain step1: atom mill {player:'self', n:3, gate:true}。不足時は何もリムーブせず連鎖を停止する（公式Q&A）。
