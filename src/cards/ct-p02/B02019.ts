// cards/ct-p02/B02019 伊織無我 (character) — Task A green候補 (engine変更0)
...
//   - 残りをシャッフルしてデッキの下に移す => deckToBottomBound{bindKey:'$revealed',order:'shuffle'}。公開した残りだけを無作為化し、未公開のデッキ本体はシャッフルしない。
