// cards/ct-p02/B02041P 怪盗キッド (character) — Task A green候補 (engine変更0)
...
//   - 【登場時】 => a1 trigger { hook 'enter', selfOnly:true } [src/cards/ct-p02/B02040.ts a1 / ct-p01/B01052.ts a1 = 【登場時】= triggered enter+selfOnly。triggered.ts TRIGGERED_HOOKS に 'enter' 登録 (line 57)。enter は handUseCard/next-hint/sceneEnter 全登場経路で発火 (cap-map hooks)。selfOnly=source.uid 一致 (triggered.ts:210-211, 158 selfOnlyMatches)。]
