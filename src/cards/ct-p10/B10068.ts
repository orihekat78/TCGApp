...
const a2: AbilityDef = {
  ...
  effect: { kind: 'sequence', steps: [
    ...
    { kind: 'conditional', if: { kind: 'bound', key: '$matched', presence: 'matched' }, then: { kind: 'atom', verb: 'handAddFromDeck', args: { player: 'self', cardId: '$matched.cardId', presentation: 'public-selected-card', deferRefresh: true } } },
