...
const grant = (kw: string) => ({ kind: 'atom' as const, verb: 'charGrantKeyword' as const, args: { player: 'self', max: 1, side: 'either', kw, scope: 'turn' } });
const a1: AbilityDef = {
...
export const B09067P: CardDef = { id: 'B09067P', no: '1009/B09067P', kind: 'event', names: ['「よしキャメル…走れ!!」'], colors: ['赤'], level: 5, traits: [], rarity: 'CP', imageUrl: '1775608890059641.jpg', abilities: [a1], ruleRefs: ['rules/10-action-event.md', 'rules/13-keywords.md', 'rules/15-abilities-effects.md'] };
