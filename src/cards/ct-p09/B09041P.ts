// cards/ct-p09/B09041P 京極真 (キャラ・パラレル) — Task D batch (2026-06-12)
...
//
// 句マッピング: B09041.ts と同一 (a1: action:guarded+guardUid levelMax6 → contactImmune_action /
//   a2: wasGuardedThisTurn 記録 helper / a3: 宣言 turn1 + charTurnEffect 条件 → sceneRemove levelMin7)。
...
// a3 の宣言条件用 helper (B09041 a2 と同一)
const a2: AbilityDef = {
  id: 'a2',
  type: 'triggered',
  scope: 'on-scene',
