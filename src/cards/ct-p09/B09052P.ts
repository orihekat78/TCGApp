...
export const B09052P: CardDef = {
  id: 'B09052P', no: '0995/B09052P', kind: 'event', names: ['い、いつの間に!?'], colors: ['白'], level: 2, traits: [], rarity: 'CP', imageUrl: '1775608872666423.jpg', abilities: [a1, a2],
  ruleRefs: ['rules/09-cutin-disguise.md', 'rules/15-abilities-effects.md', 'rules/17-icons.md', 'rules/19-special-rules.md', 'rules/22-qa-action-contact.md'],
};
