// cards/ct-p09/B09071P 萩原千速 (character, パラレル) — engine拡張 wave#2 cluster15 follow-up (2026-06-18)
...
//
// B09071 のパラレル (テキスト・能力とも完全同一、rarity/imageUrl のみ差)。句マッピングは B09071.ts 参照。
