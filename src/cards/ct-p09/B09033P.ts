// cards/ct-p09/B09033P 「ひょっとしたら…」 (event)
...
// grounding: .claude/specs/grounding/B09033P.md
...
export const B09033P: CardDef = {
  id: 'B09033P', no: '0977/B09033P', kind: 'event', names: ['「ひょっとしたら…」'], colors: ['緑'], level: 6,
  traits: [], rarity: 'CP', imageUrl: '1775608835857259.jpg', abilities: [a1],
