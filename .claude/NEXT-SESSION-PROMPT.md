...
> - **次セッション = W5 (+W6 着手)**:
>   - **W5 dyn/cost**: r37 可変数 cost (→B05097 解禁) / r38 P52 / r47 残 / r43 risky latch — 着手時に W5 設計 workflow (sonnet5 grounding+設計 → opus synthesis、W4 の w4-design-grounding 型を流用) を先に起動。backlog 再 grep 必須 (origin/main = a93897ec 基準)。
