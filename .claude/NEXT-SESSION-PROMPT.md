...
- **★残枚数 随時報告義務 (2026-07-09 ユーザー指示)**: session 開始時 + batch/wave 出荷ごとに
  ...
  出荷後は本ファイルのこの行も更新する。
- vitest baseline = **4525 pass +1 skip** (batch3-6 probe +143) / smoke winsA=**472** exceptions=0 / 8 lint err0。
