...
| rep | DEFER 理由 (engine gap) | 解禁条件 |
|-----|----------------------|---------|
| ~~B08059 / B08050 (継続レベル+N)~~ | ✅ **解禁済** (engine additive wave **a206e9dc**, 2026-06-24): `ContinuousModifier.lvlDelta` 追加 (apDelta/lpDelta 対称、read.char.level + candidates.matchOneFilter の2 honor site)。card-session が B08050/B08059 出荷可。spec: [engine-additive-wave-2026-06-24.md](engine-additive-wave-2026-06-24.md) | — |
