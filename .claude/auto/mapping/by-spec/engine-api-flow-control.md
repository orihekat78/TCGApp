# 🤖 Spec 参照ハブ: engine-api-flow-control

> ⚠️ このファイルは `scripts/gen-docs/gen-mapping.ts` により自動生成された。手で編集しない。
> 再生成: `npm run docs:mapping`
> Source hash: `3ca2d6323860`

仕様書 [`engine-api-flow-control`](../../../specs/engine-api-flow-control.md) を参照しているソース・関連 rule・関連 engine namespace のハブ。

## 📐 Spec 本体

- [`engine-api-flow-control`](../../../specs/engine-api-flow-control.md)

## 🧩 関連 Engine Namespace

- [`engine.flow`](../by-engine/flow.md)
