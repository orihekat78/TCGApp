# 🤖 ルール参照ハブ: 15-abilities-effects.md
...
- [`15-abilities-effects.md`](../../../rules/15-abilities-effects.md)

## 🧩 関連 Engine Namespace

- [`engine.cond`](../by-engine/cond.md) — [`api/cond`](../../api/cond.md)
- [`engine.dyn`](../by-engine/dyn.md) — [`api/dyn`](../../api/dyn.md)
...
- _...ほか 1268 件 (詳細は [mapping](../rules-to-cards.md) 参照)_
