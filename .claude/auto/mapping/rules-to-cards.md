...
| [`01-victory-conditions.md`](../../rules/01-victory-conditions.md) | 41 | `ai/match.ts`, `ai/move-enumerator.ts`, `ai/policies/heuristic.ts` ほか 38 件 |
...
| [`03-field-areas.md`](../../rules/03-field-areas.md) | 20 | `cards/ct-d08/D08019.ts`, `cards/ct-d08/D08020.ts`, `cards/ct-d11/D11005.ts` ほか 17 件 |
...
| [`08-contact.md`](../../rules/08-contact.md) | 18 | `ai/action-resolution.ts`, `ai/policies/heuristic.ts`, `cards/_shared/contactTargetMatches.ts` ほか 15 件 |
| [`09-cutin-disguise.md`](../../rules/09-cutin-disguise.md) | 110 | `cards/_shared/contactTargetMatches.ts`, `cards/_shared/eventRemoveByAP.ts`, `cards/ct-d01/D01009.ts` ほか 107 件 |
| [`10-action-event.md`](../../rules/10-action-event.md) | 16 | `cards/ct-d08/D08013.ts`, `cards/ct-d08/D08014.ts`, `cards/ct-d08/D08019.ts` ほか 13 件 |
| [`11-reasoning.md`](../../rules/11-reasoning.md) | 9 | `ai/move-enumerator.ts`, `ai/policies/heuristic.ts`, `engine/mutate/evidence.ts` ほか 6 件 |
| [`12-next-hint.md`](../../rules/12-next-hint.md) | 9 | `ai/policies/heuristic.ts`, `engine/flow/main/hand-use-card.ts`, `engine/mutate/file.ts` ほか 6 件 |
| [`13-keywords.md`](../../rules/13-keywords.md) | 61 | `ai/move-enumerator.ts`, `ai/policies/heuristic.ts`, `ai/policy.ts` ほか 58 件 |
| [`14-refresh.md`](../../rules/14-refresh.md) | 14 | `cards/ct-d08/D08013.ts`, `cards/ct-d08/D08014.ts`, `cards/ct-d08/D08015.ts` ほか 11 件 |
| [`15-abilities-effects.md`](../../rules/15-abilities-effects.md) | 134 | `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/_shared/caseResolvedHandRemove.ts`, `cards/_shared/eventRemoveByAP.ts` ほか 131 件 |
...
| [`17-icons.md`](../../rules/17-icons.md) | 150 | `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/_shared/caseMonoColor.ts`, `cards/_shared/caseTraitConditioned.ts` ほか 147 件 |
| [`18-mr.md`](../../rules/18-mr.md) | 3 | `engine/cond/eval.ts`, `engine/mutate/partner.ts`, `ui/hooks/usePartner.ts` |
| [`19-special-rules.md`](../../rules/19-special-rules.md) | 18 | `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/_shared/eventRemoveByAP.ts`, `cards/ct-d08/D08025.ts` ほか 15 件 |
| [`20-color-and-switch.md`](../../rules/20-color-and-switch.md) | 12 | `cards/_shared/caseMonoColor.ts`, `cards/ct-d08/D08024.ts`, `cards/ct-d08/D08025.ts` ほか 9 件 |
| [`21-declared-ability-cost.md`](../../rules/21-declared-ability-cost.md) | 23 | `ai/ability-ctx.ts`, `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/ct-d08/D08005.ts` ほか 20 件 |
| [`22-qa-action-contact.md`](../../rules/22-qa-action-contact.md) | 100 | `cards/_shared/contactTargetMatches.ts`, `cards/ct-d01/D01009.ts`, `cards/ct-d01/D01011.ts` ほか 97 件 |
...
| [`24-qa-naming-stun.md`](../../rules/24-qa-naming-stun.md) | 25 | `cards/_shared/partnerColorKeyword.ts`, `cards/ct-d01/D01005.ts`, `cards/ct-d02/D02003.ts` ほか 22 件 |
