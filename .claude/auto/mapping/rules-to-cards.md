...
| [`11-reasoning.md`](../../rules/11-reasoning.md) | 32 | `ai/move-enumerator.ts`, `ai/policies/heuristic.ts`, `cards/ct-d01/D01010.ts` ほか 29 件 |
...
| [`15-abilities-effects.md`](../../rules/15-abilities-effects.md) | 404 | `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/_shared/caseResolvedHandRemove.ts`, `cards/_shared/eventRemoveByAP.ts` ほか 401 件 |
...
| [`17-icons.md`](../../rules/17-icons.md) | 414 | `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/_shared/caseMonoColor.ts`, `cards/_shared/caseTraitConditioned.ts` ほか 411 件 |
