...
| [`03-field-areas.md`](../../rules/03-field-areas.md) | 84 | `cards/ct-d03/D03002.ts`, `cards/ct-d03/D03011.ts`, `cards/ct-d08/D08019.ts` ほか 81 件 |
...
| [`09-cutin-disguise.md`](../../rules/09-cutin-disguise.md) | 138 | `cards/_shared/contactTargetMatches.ts`, `cards/_shared/eventRemoveByAP.ts`, `cards/ct-d01/D01009.ts` ほか 135 件 |
| [`10-action-event.md`](../../rules/10-action-event.md) | 77 | `cards/ct-d01/D01003.ts`, `cards/ct-d01/D01006.ts`, `cards/ct-d03/D03011.ts` ほか 74 件 |
| [`11-reasoning.md`](../../rules/11-reasoning.md) | 24 | `ai/move-enumerator.ts`, `ai/policies/heuristic.ts`, `cards/ct-d01/D01010.ts` ほか 21 件 |
| [`12-next-hint.md`](../../rules/12-next-hint.md) | 11 | `ai/policies/heuristic.ts`, `cards/ct-p05/B05037.ts`, `cards/ct-p08/B08056.ts` ほか 8 件 |
| [`13-keywords.md`](../../rules/13-keywords.md) | 137 | `ai/move-enumerator.ts`, `ai/policies/heuristic.ts`, `ai/policy.ts` ほか 134 件 |
| [`14-refresh.md`](../../rules/14-refresh.md) | 66 | `cards/ct-d01/D01003.ts`, `cards/ct-d01/D01006.ts`, `cards/ct-d01/D01013.ts` ほか 63 件 |
| [`15-abilities-effects.md`](../../rules/15-abilities-effects.md) | 388 | `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/_shared/caseResolvedHandRemove.ts`, `cards/_shared/eventRemoveByAP.ts` ほか 385 件 |
...
| [`17-icons.md`](../../rules/17-icons.md) | 403 | `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/_shared/caseMonoColor.ts`, `cards/_shared/caseTraitConditioned.ts` ほか 400 件 |
| [`18-mr.md`](../../rules/18-mr.md) | 5 | `cards/ct-p05/B05066.ts`, `cards/ct-p07/B07093.ts`, `engine/cond/eval.ts` ほか 2 件 |
| [`19-special-rules.md`](../../rules/19-special-rules.md) | 80 | `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/_shared/eventRemoveByAP.ts`, `cards/ct-d01/D01003.ts` ほか 77 件 |
...
| [`26-qa-deck-refresh.md`](../../rules/26-qa-deck-refresh.md) | 25 | `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/ct-d01/D01013.ts`, `cards/ct-d02/D02011.ts` ほか 22 件 |
