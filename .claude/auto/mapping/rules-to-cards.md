...
> Source hash: `7aca21fc865c`

各公式ルールがどのソースファイルから参照されているか。未参照ルールは要確認。

**26/30** ルールが少なくとも1ファイルから参照されている。
...
| [`11-reasoning.md`](../../rules/11-reasoning.md) | 7 | `ai/move-enumerator.ts`, `ai/policies/heuristic.ts`, `engine/mutate/evidence.ts` ほか 4 件 |
| [`12-next-hint.md`](../../rules/12-next-hint.md) | 6 | `ai/policies/heuristic.ts`, `engine/flow/main/hand-use-card.ts`, `engine/mutate/file.ts` ほか 3 件 |
