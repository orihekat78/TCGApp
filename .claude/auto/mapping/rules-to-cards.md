...
| [`11-reasoning.md`](../../rules/11-reasoning.md) | 22 | `ai/move-enumerator.ts`, `ai/policies/heuristic.ts`, `cards/ct-d01/D01010.ts` ほか 19 件 |
...
| [`15-abilities-effects.md`](../../rules/15-abilities-effects.md) | 386 | `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/_shared/caseResolvedHandRemove.ts`, `cards/_shared/eventRemoveByAP.ts` ほか 383 件 |
...
| [`17-icons.md`](../../rules/17-icons.md) | 401 | `cards/_shared/caseDeclaredEvidenceFlip.ts`, `cards/_shared/caseMonoColor.ts`, `cards/_shared/caseTraitConditioned.ts` ほか 398 件 |
