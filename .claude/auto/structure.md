...
- **`tests/`** — Vitest + Playwright テスト
  ...
  - **`cards/`** — カード単体ユニットテスト
    ...
    - **`genprobe-validation/`**
      - `B01095.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
      - `B05031.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
      - `B05103.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
      - `B06018.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
      - `B06043.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
      - `B06065.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
      - `B06082.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
      - `B06098.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
      - `B07022.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
      - `B07032.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
      - `B07036.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
      - `B09022.gen.test.ts` — AUTO-GENERATED by scripts/gen-card-probes.…
