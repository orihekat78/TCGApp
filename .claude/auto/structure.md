    ...
    - **`ui+board-responsive-fill/`**
      - **`.claude/`**
        ...
        - **`reports/`**
          ...
          - `smoke-2026-06-15.md` — Smoke 1000戦レポート — smoke-2026-06-15-002732
          - `smoke-2026-06-16.json`
          - `smoke-2026-06-16.md` — Smoke 1000戦レポート — smoke-2026-06-16-105810
          - `smoke-baseline.json`
        - **`research/`**
          - **`arch/`**
            - `01-frameworks-survey.md` — 01. フレームワーク選定
        ...
        - `NEXT-SESSION-PROMPT.md` — 次セッション再開プロンプト (2026-06-16 engine拡張 cluster15 removal-observer + 26枚出荷 完了 — ALL_C…
        - `settings.json`
        - `settings.local.json`
      - **`.github/`**
        - **`workflows/`**
