...
- **`.claude/`** — Claude Code 用プロジェクトコンテキスト一式
  - **`auto/`** — 自動生成ドキュメント (scripts/gen-docs/ 出力先・手書き禁止)
    ...
    - **`mapping/`**
      - **`by-engine/`**
        ...
        - `state.md` — 🤖 Engine ハブ: engine.state
  ...
  - **`specs/`** — 設計ドキュメント (Engine API / UI / カード分析 / Round 仕様)
    ...
    - **`grounding/`**
      ...
      - `PR308.md` — PR308 grounding
      - `PR309.md` — PR309 grounding
      - `PR310.md` — PR310 grounding
      - `PR311.md` — PR311 grounding
      - `PR312.md` — PR312 grounding
      - `PR313.md` — PR313 grounding
      - `PR314.md` — PR314 grounding
      - `PR315.md` — PR315 grounding
      - `PR316.md` — PR316 grounding
      - `PR317.md` — PR317 grounding
      - `PR318.md` — PR318 grounding
      - `PR319.md` — PR319 grounding
      - `PR320.md` — PR320 grounding
...
- **`meta-app/`**
  ...
  - **`tests/`**
    - **`e2e/`**
      ...
      - `landscape-test-helpers.ts`
      - `match-surrender.spec.ts`
...
- **`src/`** — TypeScript ソース
  ...
  - **`cards/`** — カード定義 (CT-D08 + CT-D11、47 枚 + _shared 共通クラス)
    ...
    - **`_shared/`** — カード共通クラス (cutinFixedAP / partnerColorKeyword / eventRemoveByAP 等)
      ...
      - `pr306-319-promo-families.ts` — Local PR-01 TSV-equivalent ability families. Donor and promotion equivalence is
    ...
    - **`pr-01/`**
      ...
      - `PR305.ts` — cards/pr-01/PR305 萩原研二 (character PR)
      - `PR306.ts` — rules: 09-cutin-disguise.md, 15-abilities-effects.md, 17-icons.md
      - `PR307.ts` — rules: 03-field-areas.md, 08-contact.md, 14-refresh.md, 15-abilities-effects.…
      - `PR308.ts` — rules: 03-field-areas.md, 14-refresh.md, 15-abilities-effects.md, 17-icons.…
      - `PR309.ts` — rules: 03-field-areas.md, 10-action-event.md, 13-keywords.md, 14-refresh.…
      - `PR310.ts` — rules: 03-field-areas.md, 13-keywords.md, 15-abilities-effects.md, 17-icons.…
      - `PR311.ts` — rules: 09-cutin-disguise.md, 15-abilities-effects.md, 17-icons.md
      - `PR312.ts` — rules: 09-cutin-disguise.md, 15-abilities-effects.md, 17-icons.md
      - `PR313.ts` — rules: 03-field-areas.md, 08-contact.md, 14-refresh.md, 15-abilities-effects.…
      - `PR314.ts` — rules: 03-field-areas.md, 14-refresh.md, 15-abilities-effects.md, 17-icons.…
      - `PR315.ts` — rules: 03-field-areas.md, 10-action-event.md, 13-keywords.md, 14-refresh.…
      - `PR316.ts` — rules: 03-field-areas.md, 13-keywords.md, 15-abilities-effects.md, 17-icons.…
      - `PR317.ts` — rules: 09-cutin-disguise.md, 15-abilities-effects.md, 17-icons.md
      - `PR318.ts` — rules: 09-cutin-disguise.md, 15-abilities-effects.md, 17-icons.md
      - `PR319.ts` — rules: 09-cutin-disguise.md, 15-abilities-effects.md, 17-icons.md
      - `PR320.ts` — rules: 01-victory-conditions.md, 14-refresh.md, 15-abilities-effects.…
...
- **`tests/`** — Vitest + Playwright テスト
  ...
  - **`ui/`** — UI コンポーネント単体テスト
    - **`components/`**
      ...
      - `MatchModalOwners.additional-focus.test.tsx`
      - `MatchModalOwners.focus.test.tsx`
    ...
    - **`hooks/`**
      ...
      - `useEngineDispatch.occurrence-authority.test.ts`
