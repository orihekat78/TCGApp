...
- **対象ルート**: `.` (`C:/tmp/conan-wt-removed-filter`)
- **ディレクトリ数**: 208
- **ファイル数**: 3627
...
- **`.claude/`** — Claude Code 用プロジェクトコンテキスト一式
  ...
  - **`reports/`** — smoke (AI vs AI) 実行レポート・ベンチマーク結果
    ...
    - `smoke-2026-06-23-2.md` — Smoke 1000戦レポート — smoke-2026-06-23-105055
    - `smoke-2026-06-23.json`
    - `smoke-2026-06-23.md` — Smoke 1000戦レポート — smoke-2026-06-23-103842
    - `smoke-baseline.json`
