...
| `char` | `clearTurnEffects`, `disableOriginalAbilities`, `disguiseInto`, `grantKeyword`, `modifyAP`, `modifyLP`, `removeAllSetAndStacked`, `revokeKeyword`, `setCard`, `setOverrideAP`, `setOverrideLP`, `setTurnEffect`, `stackCard` |
...
| `scene` | `clearNamed`, `enter`, `removeToRemove`, `setState`, `switchEnter`, `toDeckBottom`, `tryActivate` |
| `scratchTrace` | `set` |
