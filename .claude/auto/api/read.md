...
| 名前 | メンバー |
| ---- | -------- |
| `char` | `ap`, `colors`, `declaredUseCount`, `hasKeyword`, `isNamed`, `keywords`, `level`, `lp`, `names`, `setCards`, `setCardsDetailed`, `stackedCount`, `state`, `traits`, `turnEffect` |
